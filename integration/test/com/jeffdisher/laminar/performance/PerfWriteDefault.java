 ...
 * concurrent clients, and default (non-programmable) topics.
...
public class PerfWriteDefault {
	...
	private static long _runTestLoad(int nodeCount, int clientCount, int messagesPerClient) throws Throwable {
		...
		long[] nanoTimes = Engine.runWithUnitsOnThreads(_folder.newFolder(), "WriteDefault", nodeCount, messagesPerClient, new Engine.TopicConfiguration[] {topicToCreate}, clients);
		...
		if (null != System.getenv("VERBOSE")) {
			System.out.println("PERF (WriteDefault):");
