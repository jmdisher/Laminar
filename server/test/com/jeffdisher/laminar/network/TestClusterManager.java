...
public class TestClusterManager {
	...
	public void testOutgoingConnections() throws Throwable {
		...
		callbacks.nextMutationToReturn = MutationRecord.temp(1L, 1L, topic, UUID.randomUUID(), 1L, new byte[] {1,2,3});
	...
	public void testElementSynchronization() throws Throwable {
		...
		TopicName topic = TopicName.fromString("test");
		MutationRecord record1 = MutationRecord.temp(1L, offset1, topic, clientId1, nonce1, payload1);
	...
	public void testTermMismatchInSync() throws Throwable {
		...
		// the processing of the first message but we need to do it before it tries to ack so do it before.
		downstreamManager.mainEnterFollowerState();
		MutationRecord record1 = MutationRecord.temp(1L, 1L, topic, UUID.randomUUID(), 1L, new byte[] {1,2,3});
		TestingCommands.readPeerStateAndSendMutation(upstreamManager, upstreamCallbacks, record1);
		...
		MutationRecord record2 = MutationRecord.temp(2L, 2L, topic, record1.clientId, 2L, new byte[] {2});
		...
		MutationRecord record1_fix = MutationRecord.temp(2L, record1.globalOffset, topic, record1.clientId, record1.clientNonce, new byte[] {1,2,3, 4, 5, 6});
		TestingCommands.readPeerStateAndSendMutation(upstreamManager, upstreamCallbacks, record1_fix);
		incoming = TestingCommands.readIncomingMutation(downstreamManager, downstreamCallbacks, upstreamEntry);
		Assert.assertArrayEquals(((MutationRecordPayload_Temp)record1_fix.payload).contents, ((MutationRecordPayload_Temp)incoming.payload).contents);
		...
		incoming = TestingCommands.readIncomingMutation(downstreamManager, downstreamCallbacks, upstreamEntry);
		Assert.assertArrayEquals(((MutationRecordPayload_Temp)record2.payload).contents, ((MutationRecordPayload_Temp)incoming.payload).contents);
	...
	public void testSendTooQuickly() throws Throwable {
		...
		MutationRecord record2 = MutationRecord.temp(1L, 2L, topic, record1.clientId, 2L, new byte[] {2});
