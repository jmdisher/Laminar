...
public class TestClusterConfig {
	...
	public void testEquality() throws Throwable {
		...
		ClusterConfig.ConfigEntry entry1 = new ClusterConfig.ConfigEntry(new InetSocketAddress(address, clusterPort), new InetSocketAddress(address, clientPort));
		ClusterConfig.ConfigEntry entry2 = new ClusterConfig.ConfigEntry(new InetSocketAddress(address, clusterPort), new InetSocketAddress(address, clientPort));
		ClusterConfig.ConfigEntry diff1 = new ClusterConfig.ConfigEntry(new InetSocketAddress(address, clusterPort), new InetSocketAddress(address, clientPort2));
